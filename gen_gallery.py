...
const upRamp = seg("segRamp", [{label:"Fine",value:RAMPS.fine},{label:"Blocky",value:RAMPS.blocky},{label:"Brand",value:RAMPS.brand},{label:"Pixels",value:"PIXEL"},{label:"L/F",value:"PIXLF"}], "ramp", ()=>effSel().ramp);
