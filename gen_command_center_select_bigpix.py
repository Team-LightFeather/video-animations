...
OUT = pathlib.Path(__file__).parent / "lf-select-command-center-bigpix.html"
...
// ---- persistence ----
function save(){ try{ localStorage.setItem("lfSelectCC2BP", JSON.stringify({G,O})); }catch(e){} }
(function restore(){
  try{
    const st = JSON.parse(localStorage.getItem("lfSelectCC2BP")||"null");
